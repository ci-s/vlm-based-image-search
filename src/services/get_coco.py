...
def load_cocos_like_dataset(captions_per_img, model_name, img_root = coco_root, ann_root=coco_ann_file):
    img_transform = None
    if model_name == "CLIP":
        img_transform = clip_processor
    else:
        img_transform = img_transformer(model_name)
